        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8 py-3">
          <a href="/" className="group flex items-center gap-2">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10.5px] font-mono uppercase tracking-[0.18em] text-fg-subtle">
          ...
          <div className="flex items-center gap-2">
            {!session ? (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-accent/50 bg-accent/10 px-2.5 py-1.5 text-[12.5px] font-medium text-accent hover:bg-accent/20"
              >
                <Plug size={13} />
                Connect eToro
              </button>
